...
The `analytical-cem` reference replaces only the latent rollout/readout with canonical
terminal attributes computed from that projection. Its exogenous contact and sunlight
